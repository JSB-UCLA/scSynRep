#!/usr/bin/env Rscript
#
# Example script for running scSynRep
# 
# This script demonstrates how to use the scSynRep package
...
# =============================================================================
# ALTERNATIVE: Use the all-in-one wrapper function
# =============================================================================

# If you have GTEx tissue data, you can use the wrapper function:
#
# result <- scSynRep_from_tissue(
#     tissue_name = "Liver",                    # GTEx tissue name
#     scRNA_matrix = sc_matrix,
#     gtex_data_dir = "path/to/gtex/data/",    # Directory with GTEx .RDS files
#     save_dir = model_dir,
